...
1. **信息获取极慢，时间耗不起**：人说话的语速通常只有 150~200 字/分钟，就算开 1.5 倍速，一门 40 小时的网课也得硬坐 26 个小时；而人眼扫读文字的速度是 800~1200 字/分钟，效率相差整整 5 倍；
...
**Bili-Video2Book 致力于将视频中真正有价值的推导细节、黑板演算与思维精髓，无损重构为高效、结构化、可全文检索、学完立刻做题检验的出版级文字书籍。**
...
| :--- | :--- | :--- | :--- |
| 📘 **精读教材长文**<br>`articles/` | **系统深入自学**<br>（彻底替代长视频） | 详尽推导步骤、黑板板书与数学证明、案例前因后果、**文末附带 2~3 道针对重难点的综合练习题（附可在正文溯源的详细解析）** | 概括性跳步、口水碎语、“视频中我们看到”等视听口吻、外部未经提及的虚构大厂神话 |
...
- **语料即法典，不吹虚假大厂神话**：严守闭卷事实边界，视频没讲的技术细节直接写明“课程未说明”，绝不为了套用模板而凭空捏造不存在的工业系统；
